...
public class TwitterDialog extends Dialog {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//
		// addContentView(mContent, new FrameLayout.LayoutParams((int)
		// (dimensions[0] * scale + 0.5f),
	...
	private void setUpTitle() {
		...
		// Drawable icon =
		// getContext().getResources().getDrawable(R.drawable.twitter_icon);
