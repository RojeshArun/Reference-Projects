...
//	private static final String TAG = "MemoryCache";
	...
	{
		return memoryCache==null ? new MemoryCache() : memoryCache;
	}
	...
	private MemoryCache() {
		...
		// setLimit(maxMemory/4);

		final long maxMemory = (Runtime.getRuntime().maxMemory());
//		LOGHB.e(TAG, "Max memory limit " + maxMemory / (1024 * 1024) + "MB");

		setLimit(maxMemory/8);
	}

	public void setLimit(long new_limit) {
		limit = new_limit;
//		LOGHB.e(TAG, "MemoryCache will use up to " + limit / (1024 * 1024) + "MB");
	}
	...
	private void checkSize() {
		//LOGHB.i(TAG, "cache size=" + size + " length=" + cache.size());
		if (size > limit) {
			...
			//LOGHB.i(TAG, "Clean cache. New size " + cache.size());
		}
	}
